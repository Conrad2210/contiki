...
class  dewi():
    ...
    def insertExperiment(self,id,description,date_time):        
        try:
            cursor = self.dbConnection.cursor()
            print ("INSERT INTO experiments (id, description, date_time) VALUES ({0},'{1}',{2})").format(id,description,date_time)
    ...
    def insertLatency(self,id, session_id, nodeID,timeslot,count):        
        try:
            cursor = self.dbConnection.cursor()
            print ("INSERT INTO latency(id, session_id, nodeID,timeslot,count) VALUES ({0},{1},{2},{3},{4})").format(id, session_id, nodeID,timeslot,count)
    ...
    def insertRxPackets(self,id, session_id, nodeID,count):        
        try:
            cursor = self.dbConnection.cursor()
            print ("INSERT INTO rxpackets(id, session_id, nodeID,count) VALUES ({0},{1},{2},{3})").format(id, session_id, nodeID,count)
    ...
    def insertTxPackets(self,id, session_id, nodeID,count):        
        try:
            cursor = self.dbConnection.cursor()
            print ("INSERT INTO txpackets(id, session_id, nodeID,count) VALUES ({0},{1},{2},{3})").format(id, session_id, nodeID,count)
