...
.factory('cDB', ['Loki', function (Loki) {
        ...
        cDB.addUserProfileImage = function (data) {
            ...
            var userprofile = collection.find({ name: "UserProfile" })[0].data;
            userprofile.image_string = data;
        ...
        cDB.addCMSAccountImageString = function (project, image_url, image_string) {
            ...
            var temp = collection.find({ name: project })[0].data;
            temp.forEach(function (element, index, array) {

                if (element.image_url == image_url) {
                    element.image_string = image_string;
                }
            })
        ...
        cDB.addCMSStoreBGImageString = function (project, bg_image_url, bg_image_string) {
            ...
            temp.forEach(function (element, index, array) {
                ...
                if (element.bg_image_url == bg_image_url) {
                    element.bg_image_string = bg_image_string;
                }
            })
