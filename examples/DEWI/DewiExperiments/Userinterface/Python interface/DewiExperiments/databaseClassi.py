...
class  databaseConnection():
    ...
    def __init__(self):
        try:
            self.dbConnection = mysql.connect(host='157.190.53.108',user='root',password="root",db=self.db,buffered=True)
    ...
    def insertExperiment(self,id,description,date_time):        
        try:
            self.dbConnection = mysql.connect(host='157.190.53.108', user='root', password="root",
